...
public class GameDatabase {
	...
	private static final String DB_CREATE = "create table " + DB_TABLE + " ("
			+ KEY_ID + " " + ID_OPTIONS + ", " + KEY_TYPE + " " + TYPE_OPTIONS
			+ ", " + KEY_ICON + " " + ICON_OPTIONS + ", " + KEY_LEVEL + " "
			+ LEVEL_OPTIONS + ", " + KEY_ARMOR + " " + ARMOR_OPTIONS + ", "
			+ KEY_DAMAGE + " " + DAMAGE_OPTIONS + ", " + KEY_BUY + " "
			+ BUY_OPTIONS + ");";
	// --

	// CREATE TABLE MAPS
	private static final String DB_CREATE_MAPS = "create table "
			+ DB_TABLE_MAPS + " (" + KEY_ID + " " + ID_OPTIONS + ", "
			+ KEY_NAME + " " + NAME_OPTIONS + ", " + KEY_MONSTERSCOUNT + " "
			+ MONSTERSCOUNT_OPTIONS + ", " + KEY_BASEGOLD + " "
			+ BASEGOLD_OPTIONS + ", " + KEY_BASEEXPERIENCE + " "
			+ BASEEXPERIENCE_OPTIONS + ");";
	//

	// CREATE TABLE MONSTERS
	private static final String DB_CREATE_MONSTERS = "create table "
			+ DB_TABLE_MONSTERS + " (" + KEY_ID + " " + ID_OPTIONS + ", "
	...
	public Item getItem(String icon) {
		String[] columns = { KEY_ID, KEY_TYPE, KEY_ICON, KEY_LEVEL, KEY_ARMOR,
				KEY_DAMAGE, KEY_BUY };
	...
	public Cursor getAllMaps() {
		String[] columns = { KEY_ID, KEY_NAME, KEY_MONSTERSCOUNT, KEY_BASEGOLD,
				KEY_BASEEXPERIENCE };
		return db.query(DB_TABLE_MAPS, columns, null, null, null, null, null);
	}

	public Cursor getAllMonsters() {
		String[] columns = { KEY_ID, KEY_MONSTERICON, KEY_MONSTERTYPE,
				KEY_MONSTERHEALTH, KEY_MONSTERDAMAGE, KEY_MONSTERARMOR,
				KEY_MONSTERCOORDS };
		return db.query(DB_TABLE_MONSTERS, columns, null, null, null, null,
				null);
	}
